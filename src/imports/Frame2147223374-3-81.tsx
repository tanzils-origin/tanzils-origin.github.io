import svgPaths from "./svg-f6yn8laedl";
  ...
  return (
    <div className="absolute contents inset-0" data-name="Dribbble-Light-Preview">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icons">
          <path clipRule="evenodd" d={svgPaths.pbdc31f0} fill="var(--fill-0, #2D2D2D)" fillRule="evenodd" id="github-[#142]" />
        </g>
      </svg>
    </div>
  );
...
function LinkedinSvgrepoCom() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="linkedin-svgrepo-com 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_3_87)" id="linkedin-svgrepo-com 1">
          <path d={svgPaths.p14d8f900} fill="var(--fill-0, #2D2D2D)" id="Vector" />
        </g>
        <defs>
  ...
  return (
    <div className="h-[22.8px] relative shrink-0 w-[27.36px]" data-name="layer1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 23">
        <g id="layer1">
          <path d={svgPaths.p1fe192f0} fill="var(--fill-0, #2D2D2D)" id="rect4592" />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[#2d2d2d] box-border content-stretch flex gap-[8px] items-center overflow-clip px-[16px] py-[8px] relative rounded-[40px] shrink-0" data-name="Button">
      <p className="font-['JetBrains_Mono:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[14px] text-center text-nowrap text-white whitespace-pre">Resume</p>
...
export default function Frame3() {
  return (
    <div className="bg-neutral-100 relative size-full">
      <Frame />
      <p className="absolute font-['Noto_Serif:Medium',sans-serif] font-medium leading-[normal] left-1/2 text-[#2d2d2d] text-[40px] text-center text-nowrap top-[440px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Hey, I’m Tanzil.
      </p>
      <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[normal] left-1/2 text-[#2d2d2d] text-[16px] text-center text-nowrap top-[518px] translate-x-[-50%] whitespace-pre">
